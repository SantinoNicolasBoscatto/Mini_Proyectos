...
namespace Libreria
{
    public class CuentaBancariaXUnitTests
    {
        ...
        [Fact] // realizo un unit-testing sobre un Mock
        public void CuentaBancariaLoggerGeneral_LogMocking_ReturnTrue()
        {
            ...
            Assert.Equal(textoPrueba.ToLower(), result);
        }
        [Fact] // realizo un unit-testing sobre un Mock, con parametros Ouput 
        ...
        [Fact] // realizo un unit-testing sobre un Mock, con parametros Ref
        ...
        [Fact] // Seteo los valores de las propiedades de un Mock
        public void CuentaBancariaLoggerGeneral_LogMockingPropiedadPrioridadTipo_ReturnsTrue()
        {
            ...
            Assert.Equal("Warning", loggerMock.Object.TipoLogger);
            Assert.Equal(1, loggerMock.Object.PrioridadLogger);
            ...
            Assert.Equal("Hola, Soy una callback", text);
        }
